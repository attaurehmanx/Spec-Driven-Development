      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/40 dark:border-purple-500/40 mb-6"
          >
          ...
          >
            ...
            <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl mt-3 text-gray-900 dark:text-gray-100">
          ...
          <motion.p
            ...
            className="mt-4 max-w-3xl mx-auto text-xl sm:text-2xl text-gray-700 dark:text-gray-300 font-medium leading-relaxed"
          >
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-1.5 text-gray-900 dark:text-gray-100">Secure & Private</h3>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-1.5 text-gray-900 dark:text-gray-100">Lightning Fast</h3>
                <p className="text-gray-700 dark:text-gray-300">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-1.5 text-gray-900 dark:text-gray-100">AI-Powered</h3>
                <p className="text-gray-700 dark:text-gray-300">
