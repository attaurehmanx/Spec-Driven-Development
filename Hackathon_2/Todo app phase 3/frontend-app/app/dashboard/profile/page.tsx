      ...
      <div className="container mx-auto py-4">
        <div className="max-w-4xl mx-auto">
          <Card className="overflow-hidden">
            ...
            <CardContent className="pt-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-3">
                  <div className="mb-2 px-3 py-1.5 rounded-lg bg-gradient-to-r from-purple-600 to-pink-600">
              ...
              <div className="pt-4 flex justify-end space-x-2.5">
                {isEditing ? (
                  <>
                    <button
                      className="px-5 py-2.5 rounded-xl font-bold text-gray-700 dark:text-gray-300 bg-white dark:bg-slate-800 border-2 border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-slate-700 transition-all"
                      onClick={() => {
                        setIsEditing(false);
                        setFirstName(user?.first_name || '');
                        setLastName(user?.last_name || '');
                    ...
                    <button
                      className="px-5 py-2.5 rounded-xl font-bold text-white bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 shadow-lg shadow-purple-500/50 hover:shadow-xl transition-all"
            ...
            <CardFooter className="bg-red-50/50 dark:bg-red-900/20 border-t border-red-100 dark:border-red-800 p-5">
