              ...
              <div className="relative glass-strong rounded-3xl border-2 border-white/30 dark:border-white/20 shadow-2xl overflow-hidden">
                ...
                <div className="relative px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <div className="relative flex items-center justify-between">
                    <h2 className="text-2xl font-extrabold bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 dark:from-purple-400 dark:via-pink-400 dark:to-cyan-400 bg-clip-text text-transparent">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled={isSubmitting}
                      className={`w-full px-4 py-2.5 rounded-xl border-2 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                        errors.title
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      disabled={isSubmitting}
                      className={`w-full px-4 py-2.5 rounded-xl border-2 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all resize-none disabled:opacity-50 disabled:cursor-not-allowed ${
                        errors.description
                          ? 'border-red-500 focus:border-red-500'
                          : 'border-gray-300 dark:border-gray-600 focus:border-purple-500'
                      }`}
                  ...
                  {mode === 'edit' && (
                    <div className="flex items-center gap-2.5">
                      <input
                        ...
                        disabled={isSubmitting}
                        className="w-4 h-4 rounded border-2 border-gray-300 dark:border-gray-600 text-purple-600 focus:ring-2 focus:ring-purple-500 disabled:opacity-50"
                      />
