  ...
  return (
    <div className="flex flex-col min-h-screen">
      <ResponsiveLayout
        title="Dashboard"
        sidebar={
          <div className="flex flex-col h-full p-2 bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950">
              ...
              <ul className="space-y-1">
                {navigationItems.map((item) => (
                  <li key={item.name}>
                    <Link
                      href={item.href}
                      className={`flex items-center gap-3 px-3 py-2 text-base font-bold rounded-xl transition-all duration-200 group relative ${
                        item.active
            ...
            <div className="mt-auto pt-3 border-t-2 border-gray-300 dark:border-gray-700">
              <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl p-3 border border-gray-200 dark:border-gray-700 shadow-lg">
                <div className={`flex items-center gap-3 ${isSidebarCollapsed ? 'justify-center' : ''} mb-2`}>
                  <Avatar
                    ...
                    className="w-9 h-9 rounded-xl border-2 border-purple-500/50 shadow-lg"
                  />
                  {!isSidebarCollapsed && (
