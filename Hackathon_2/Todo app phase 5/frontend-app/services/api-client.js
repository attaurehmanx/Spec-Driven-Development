...
class ApiClient {
   ...
   * @param {string} filters.tags - Filter by tags (comma-separated)
   * @param {string} filters.status - Filter by status (done, not_done)
   * @param {string} filters.search - Search in title and description
   * @param {string} filters.sort - Sort by (priority, due_date, created_at, title)
   */
